                   ...
                   <?php if (!empty($TablaProduccionFechaHasProductos)) {
                       foreach ($TablaProduccionFechaHasProductos as $row) { ?>
                           <tr class="fila">
                               ...
                               <td><b><?php try {echo htmlspecialchars($row['idProductos']);} catch (Exception $e) {echo "Undefined";} ?></b></td>
                       ...
                       <tr>
                           <td colspan="4" class="text-center">No hay aun Produccion el dia de hoy</td>
                       </tr>
                   <?php } ?>
                   </tbody>
               </table>    </div>
